...
// require app_path() ."/Http/Controllers/api/sync/conndb.php";
// require app_path() ."/tracking/inc_header.php";
...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col px-0">
                <div class="img-width">
                    <img class="mobile-none" src="/local/app/tracking/images/banner.jpg">
                    <img class="mobile" src="/local/app/tracking/images/banner-mobile.jpg">
                </div>
            </div>
        </div>
    </div>
                        ...
                        <ul class="service-section">
                            <li>
                                <div class="serviceBox">
                                    <div class="service-img"><img src="/local/app/tracking/images/service01.png"></div>
                                    <p>Courier service</p>
                                </div>
                            </li>
                            <li>
                                <div class="serviceBox">
                                    <div class="service-img"><img src="/local/app/tracking/images/service02.png"></div>
                                    <p>ระบุเวลาได้</p>
                                </div>
                            </li>
                            <li>
                                <div class="serviceBox">
                                    <div class="service-img"><img src="/local/app/tracking/images/service03.png"></div>
                                    <p>บริการเก็บเงินปลายทาง (COD)</p>
                                </div>
                            </li>
                            <li>
                                <div class="serviceBox">
                                    <div class="service-img"><img src="/local/app/tracking/images/service04.png"></div>
                                    <p>ค้นหาพื้นที่บริการด้วย Postcode</p>
                                </div>
                            </li>
                            <li>
                                <div class="serviceBox">
                                    <div class="service-img"><img src="/local/app/tracking/images/service05.png"></div>
                                    <p>รับพัสดุหน้างาน</p>
                                </div>
                            </li>
                        </ul>      
                ...
                <div class="row">
                    <div class="col-lg-10 col-12 offset-lg-1">
                        <ul class="list-content">
                            <li><i class="fas fa-chevron-circle-right"></i>ราคาจัดส่ง <span>เริ่มต้นเพียง 35 บาท</span></li>
