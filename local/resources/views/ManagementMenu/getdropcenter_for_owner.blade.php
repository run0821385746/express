    ...
    <div class="row">
        @foreach ($DropCenters as $DropCenter)
            <div class="col-md-6 col-xl-4">
                <a href="/select_drop_center/{{$DropCenter->id}}" style="text-decoration: none;">
                    <div class="card text-white bg-success border-secondary mb-3">
                        <div class="card-header">{{$DropCenter->drop_center_name.'('.$DropCenter->drop_center_name_initial.')'}}</div>
                        <div class="card-body text-dark" style="background-color:#fff; height:300px; max-height:120px; overflow: auto;">
                        <h5 class="card-title"><b>เบอร์มือถือ : </b>{{$DropCenter->drop_center_phone}}</h5>
                        <p class="card-text"><b>ที่ตั่ง : {{$DropCenter->drop_center_address}} {{$DropCenter->District->name_th}} {{$DropCenter->amphure->name_th}} {{$DropCenter->province->name_th}} {{$DropCenter->drop_center_postcode}}</b></p>
                        </div>
                    </div>
                </a>
            </div>
                ...
                <div class="widget-content-outer">
                    <div class="widget-content-wrapper">
                        <div class="widget-content-left">
                            <div class="widget-heading">รายรับ</div>
                            <div class="widget-subheading">DropCenter</div>
                        </div>
                        <div class="widget-content-right">
                            <div class="widget-numbers text-success">65,500</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card mb-3 widget-content">
                <div class="widget-content-outer">
                    <div class="widget-content-wrapper">
                        <div class="widget-content-left">
                            <div class="widget-heading">รายรับ</div>
                            <div class="widget-subheading">Courier Dalivery</div>
                        </div>
                        <div class="widget-content-right">
                            <div class="widget-numbers text-warning">45,000</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-6 col-xl-4">
            <div class="card mb-3 widget-content">
                <div class="widget-content-outer">
                    <div class="widget-content-wrapper">
                        <div class="widget-content-left">
                            <div class="widget-heading">รวมยอดรายรับทั้งหมด</div>
                            <div class="widget-subheading">DropCenter + Courier Dalivery</div>
                        </div>
                        <div class="widget-content-right">
                            <div class="widget-numbers text-danger">110,500</div>
                        </div>
                    </div>
                </div>
            </div>
