...
<body>
    ...
    <div align='center' style='margin-top:20px;'>
        <div style='font-size:18px; font-weight: bold;'>SERVICE EXPRESS</div>
        <div style='font-size:18px; margin-top:-5px; font-weight: bold;'>{{$droupsentername}}</div>
        <div style='font-size:18px; margin-top:-5px; font-weight: bold;'>Tel/Fax: {{$dropCenter->drop_center_phone}}</div>
        <div style='font-size:18px; margin-top:-5px; font-weight: bold;'>*..ขอบคุณที่มาใช้บริการ..*</div>
    </div>
    <div>
        <div style='font-size:18px; line-height:16px;'>วันที่ : {{$booking->created_at}}</div>
        <div style='font-size:18px; margin-top:-5px; line-height:16px;'>บิลเลขที่ : {{$booking->booking_no}}</div>
        <div style='font-size:18px; margin-top:-5px; line-height:16px;'>แคทเชียร์ : {{$employee->emp_firstname.' '.$employee->emp_lastname}}</div>
    </div>
        ...
        @foreach ($trackings as $tracking)
            ...
            ?>
                @if ($tracking->tracking_no !== "")
                    ...
                    <tr style='paddong:0px; line-height:10px;'>
    ...
    <table width='100%'>
        ...
        <tr style='paddong:0px; line-height:7px;'>
    ...
    <div align='center' style='margin-top:0px;'>
        <div style='font-size:18px; margin-top:-5px; line-height:17px;'>พบสิ่งของต้องห้ามผิดกฎหมาย</div>
        <div style='font-size:18px; margin-top:-5px; line-height:17px;'>ทางร้านไม่ขอรับผิดชอบใดๆทั้งสิ้น</div>
        <div style='font-size:18px; margin-top:-5px; line-height:17px;'>สามารถเช็กพัสดุที่ท่านจัดส่งได้ที่</div>
        <div style='font-size:18px; margin-top:-5px; line-height:17px;'>www.service-express.com/check-tracking</div>
    </div>
    <br>
    {{-- <div class="col-md-4">
