            ...
            <table id="customers" style="line-height: 8px; max-width:100%; width:100%;">
                <thead>
                    <tr style="border-top:none;">
                        <th valign="top" colspan="7" style="padding: 5px 0px 5px 0px; border:none; background-color:#fff;">
                                ...
                                <tbody>
                                    <tr>
                                        <td colspan="5" style="border-collapse: collapse; border:none; background-color:#fff; padding:-10px 15px;">
                                            <div class="myDiv">
                                                <h4>SERVICE EXPRESS <br>Parcel Successful Delivery report</h4>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                ...
                <tbody>
                    @php
                        $i = 1;
                        $count_qty = count($SaleOthers);
                        $service_price_sum = 0;
                    @endphp
                    @foreach ($SaleOthers as $index)
                        @php
                        @endphp
                        <tr>
                            ...
                            <td valign="top" style="font-size: 12px !important; line-height: 6px; padding:5px 10px; text-align: center;">
                                {{ $index->productPrice->product_name }}
                            </td>
                            <td valign="top" style="font-size: 12px !important; line-height: 6px; padding:5px 10px; text-align: right;">
                                {{ number_format($index->sale_other_price,2) }}
                                @php
                                    $service_price_sum += $index->sale_other_price;
                                @endphp
                            </td>
                            <td valign="top" style="font-size: 12px !important; line-height: 6px; padding:5px 10px; text-align: center;">
                            ...
                            <td valign="top" style="font-size: 12px !important; line-height: 6px; padding:5px 10px; text-align: center;">
                                {{ $index->Booking->Employee->emp_firstname.' '.$index->Booking->Employee->emp_lastname }}
                            </td>
                            <td valign="top" style="font-size: 12px !important; line-height: 6px; padding:5px 10px; text-align: center;">
                    ...
                    @endforeach
                    <tr>
                        <td valign="top" colspan="3" style="font-size: 12px !important; line-height: 6px; padding:5px 10px; text-align: center;">
                            {{$count_qty}} รายการ
                        </td>
                        <td valign="top" style="font-size: 12px !important; line-height: 6px; padding:5px 10px; text-align: right;">
