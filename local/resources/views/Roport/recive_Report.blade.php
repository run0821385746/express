                                ...
                                <tbody>
                                    <tr>
                                        <td colspan="5" style="border-collapse: collapse; border:none; background-color:#fff; padding:-10px 15px;">
                                            <div class="myDiv">
                                                <h4>SERVICE EXPRESS <br>Parcel recive report</h4>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                ...
                <tbody>
                    ...
                    @foreach ($Tracking as $index)
                        ...
                        <tr>
                            ...
                            <td valign="top" style="font-size: 12px !important; line-height: 6px; padding:5px 10px; text-align: center;">
                                @php
                                    $SubTrackings = App\Model\SubTracking::where('subtracking_tracking_id', $index->id)->get();
                            ...
                            <td valign="top" style="font-size: 12px !important; line-height: 6px; padding:5px 10px; text-align: right;">
                                {{ number_format($index->tracking_amount,2) }}
                                @php
                                    $service_price_sum += $index->tracking_amount;
                                @endphp
                            </td>
                            <td valign="top" style="font-size: 12px !important; line-height: 6px; padding:5px 10px; text-align: right;">
                                @php
                            ...
                            <td valign="top" style="font-size: 12px !important; line-height: 6px; padding:5px 10px; text-align: center;">
                                {{$index->booking->DropCenter->drop_center_name_initial}}
                            </td>
                        </tr>
                    @endforeach
                    <tr>
